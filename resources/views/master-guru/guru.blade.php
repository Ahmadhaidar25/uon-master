...
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-6">
				<h3 class="card-title"><i class="bi bi-server"></i>Data Guru</h3>
			</div>
			<div class="col-6">
				<a href="{{url('/tambah/guru')}}" class="btn btn-success" style="float: right;">
						...
						<tr>
							<td>
								<div class="btn-group" role="group" aria-label="Basic outlined example">
									<a href="{{url('/edit/guru/'.$x->id)}}" class="btn btn-outline-warning">Edit</a>
